...
"[project]/src/app/my-car/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MyCarPage() {
    _s();
    const [carState, setCarState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('on');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyCarPage.useEffect": ()=>{
            ...
            }["MyCarPage.useEffect"], undefined, {
                "MyCarPage.useEffect": (error)=>{
                ...
                "MyCarPage.useEffect.animate": ()=>{
                    ...
                    if (Math.abs(doorProgress - targetProgress) > 0.01) {
                        ...
                        doorPartsRef.current.forEach({
                            "MyCarPage.useEffect.animate": ({ mesh, side })=>{
                                if (side === 'FL') {
                    ...
                    if (carRef.current) {
                        if (carStateRef.current === 'on') {
                            ...
                            wheelsRef.current.forEach({
                                "MyCarPage.useEffect.animate": (wheel)=>{
            ...
            // Resize handler
            const handleResize = {
                "MyCarPage.useEffect.handleResize": ()=>{
...
_s(MyCarPage, "cQTqNCdJxDKzpB9g8x+5MtbPu6E=");
_c = MyCarPage;
var _c;
__turbopack_context__.k.register(_c, "MyCarPage");
...
//# sourceMappingURL=src_app_my-car_page_tsx_da49d0ed._.js.map